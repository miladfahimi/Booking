...
(uuid_generate_v4(),'Service 1', 'CLAY', true, (SELECT id FROM provider WHERE name = 'Tennis Provider 1'), 100.00, 'USD', 60, '08:00:00', '18:00:00', 30, '/images/service1.png', 4.5, NOW(), NOW(), 'available', 10, '["beginner", "outdoor"]'),
(uuid_generate_v4(),'Service 2', 'GRASS', true, (SELECT id FROM provider WHERE name = 'Tennis Provider 2'), 120.00, 'USD', 90, '09:00:00', '20:00:00', 45, '/images/service2.png', 4.2, NOW(), NOW(), 'available', 15, '["advanced", "outdoor"]');

-- Insert data into feedback table
INSERT INTO feedback (id, comment, rating, created_at, provider_id, service_id) VALUES
(uuid_generate_v4(),'Great provider!', 5, '2024-07-01 10:00:00', (SELECT id FROM provider WHERE name = 'Tennis Provider 1'), NULL),
(uuid_generate_v4(),'Nice service', 4, '2024-07-02 11:00:00', NULL, (SELECT id FROM service WHERE name = 'Service 2'));
