...
INSERT INTO service (id,name, type, availability, provider_id) VALUES
(uuid_generate_v4(),'Service 1', 'CLAY', true, (SELECT id FROM provider WHERE name = 'Tennis Provider 1')),
(uuid_generate_v4(),'Service 2', 'GRASS', true, (SELECT id FROM provider WHERE name = 'Tennis Provider 2'));
