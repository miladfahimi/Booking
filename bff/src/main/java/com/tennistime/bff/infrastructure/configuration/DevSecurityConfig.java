package com.tennistime.bff.infrastructure.configuration;

import com.tennistime.bff.infrastructure.security.JwtAuthenticationFilter;
...
public class DevSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/portal/user/**").hasAnyRole("ADMIN","PROVIDER_OWNER","USER")
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.addAllowedOrigin("http://46.62.151.135:808283");
